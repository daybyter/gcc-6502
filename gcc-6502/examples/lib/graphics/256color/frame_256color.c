...
void frame_256color( unsigned int x
  ...
  horizontalLine_256color( x, y, x2, color);
  horizontalLine_256color( x, y2, x2, color);
  if( abs( y2 - y) > 1) {
    verticalLine_256color( x, y + 1, y2 - 1, color);
    verticalLine_256color( x2, y + 1, y2 - 1, color);
  }
}
